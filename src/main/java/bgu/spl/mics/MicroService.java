...
public abstract class MicroService implements Runnable {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        event_callback_map.putIfAbsent(type, callback);
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        broadcast_callback_map.putIfAbsent(type, callback);
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message curr_msg = MessageBusImpl.getInstance().awaitMessage(this);
                if (curr_msg instanceof Event) {
                    event_callback_map.get(curr_msg.getClass()).call(curr_msg);
                } else {
                    broadcast_callback_map.get(curr_msg.getClass()).call(curr_msg);
                }
            } catch (Exception e) {
            }
        }
